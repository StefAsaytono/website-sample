...
const stats = [
  { name: "Successful Projects", value: "30+" },
  ...
  return (
    <div className="bg-white">
      ...
      <div className="px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-25 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            >
              Your website is more than just a digital space—it’s your brand’s
              first impression. We craft modern, high-performing websites that
              captivate your audience, drive engagement, and turn visitors into
              loyal customers. Let’s build something extraordinary together.
            </p>
          </div>
        </div>
      </div>
      {/* ------------------- */}
      <div className="relative bg-white py-10 sm:py-25 bg-opacity-100 w-full h-full">
        <div data-aos="zoom-in-up" className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base/7 font-semibold text-blue-700 mb-5">
            ...
            <p className="mt-6 text-lg/8 text-gray-800">
              From seamless design to high-performance hosting, we provide the
              tools and expertise to bring your vision to life. Secure,
              scalable, and built to impress.
            </p>
          </div>
      ...
      <div className="relative isolate overflow-hidden bg-gray-900">
        ...
        />
        <div data-aos="zoom-in-up" className="py-18 sm:py-32">
          <div
            aria-hidden="true"
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0">
              ...
              <p className="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl/8">
                ...
                optimized for performance, engagement, and growth:
              </p>
            </div>
      ...
      <section className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl lg:max-w-4xl" data-aos="zoom-in">
          <img
            ...
            height="48"
            src="https://img.icons8.com/pulsar-gradient/48/quote.png"
            alt="quote"
          />
          <figure className="mt-10">
            <blockquote className="text-center text-xl/8 font-semibold text-gray-900 sm:text-2xl/9">
              <p>
                "A great website isn’t just something people see—it’s an
                experience that engages, inspires, and drives action."
              </p>
            </blockquote>
          ...
          >
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <p className="mt-6 text-lg/8 text-pretty text-gray-300">
                Choose from a variety of stunning, customizable themes designed
                to match your style and enhance your online presence.
              </p>
            </div>
      ...
      <div className="bg-white py-24 sm:py-32 relative">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div
            data-aos="zoom-in"
            className="mx-auto grid max-w-lg grid-cols-3 items-center gap-x-8 gap-y-5 sm:max-w-xl sm:grid-cols-3 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-3"
          >
